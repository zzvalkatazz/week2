...
//firstEven винаги сочи към първия четен възел и не се променя след инициализацията.
//lastEven се променя при всяка итерация, когато намерим нов четен възел, и така актуализираме следващия възел за последния четен възел.